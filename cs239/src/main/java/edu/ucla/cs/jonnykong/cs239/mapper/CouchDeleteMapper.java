...
public class CouchDeleteMapper implements Serializable {

    /**
     * TODO: how should the mapper be parameterized?
     */
    public CouchDeleteMapper() {}
     ...
     */
    public Pair<String, String> toDeleteTuple(ITuple tuple) {
        ...
        return new Pair<String, String>(_id, _rev);
    }
}